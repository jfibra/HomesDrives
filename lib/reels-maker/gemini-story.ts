...
export async function generateReelStoryPlan(params: {
  ...
  const prompt = [
    ...
    '- sceneRole durations: EVERY scene ~2.35 seconds (clear ~2s hold after soft blends).',
    '- Transitions: soft dissolve / smoothleft / smoothright / slide / wipe-up. Never hard-cut between photos.',
